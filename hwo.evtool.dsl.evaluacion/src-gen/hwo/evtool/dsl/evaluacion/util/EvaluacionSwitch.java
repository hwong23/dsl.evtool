...
public class EvaluacionSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        EvaluaccionModel evaluaccionModel = (EvaluaccionModel)theEObject;
        T result = caseEvaluaccionModel(evaluaccionModel);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Evaluaccion Model</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Evaluaccion Model</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEvaluaccionModel(EvaluaccionModel object)
  {
    return null;
  }
