...
public class EvaluacionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EvaluacionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEvaluacionAccess().getGroup_1_3_0(), "rule__Evaluacion__Group_1_3_0__0");
			...
			builder.put(grammarAccess.getEvaluacionAccess().getFormacionValAssignment_1_3_0_2(), "rule__Evaluacion__FormacionValAssignment_1_3_0_2");
			builder.put(grammarAccess.getEvaluacionAccess().getExperienciaAssignment_1_3_1_0(), "rule__Evaluacion__ExperienciaAssignment_1_3_1_0");
			builder.put(grammarAccess.getEvaluacionAccess().getExperienciaValAssignment_1_3_1_2(), "rule__Evaluacion__ExperienciaValAssignment_1_3_1_2");
			builder.put(grammarAccess.getEvaluacionAccess().getCertificacionAssignment_1_3_2_0(), "rule__Evaluacion__CertificacionAssignment_1_3_2_0");
			builder.put(grammarAccess.getEvaluacionAccess().getCertificacionValAssignment_1_3_2_2(), "rule__Evaluacion__CertificacionValAssignment_1_3_2_2");
			...
			builder.put(grammarAccess.getCriterioPropuestaAccess().getCriterioAssignment_2(), "rule__CriterioPropuesta__CriterioAssignment_2");
			builder.put(grammarAccess.getCriterioPropuestaAccess().getPuntuacionAssignment_5(), "rule__CriterioPropuesta__PuntuacionAssignment_5");
