 ...
 * </p>
 * <ul>
 *   <li>{@link hwo.evtool.dsl.evalcn.evaluacion.Expresion#getTipo <em>Tipo</em>}</li>
 *   <li>{@link hwo.evtool.dsl.evalcn.evaluacion.Expresion#getComentario <em>Comentario</em>}</li>
 * </ul>
 *
 * @see hwo.evtool.dsl.evalcn.evaluacion.EvaluacionPackage#getExpresion()
 * @model
 * @generated
 */
public interface Expresion extends EObject
{
   ...
   * @see hwo.evtool.dsl.evalcn.evaluacion.EvaluacionPackage#getExpresion_Tipo()
  ...
  /**
   * Sets the value of the '{@link hwo.evtool.dsl.evalcn.evaluacion.Expresion#getTipo <em>Tipo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see hwo.evtool.dsl.evalcn.evaluacion.EvaluacionPackage#getExpresion_Comentario()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link hwo.evtool.dsl.evalcn.evaluacion.Expresion#getComentario <em>Comentario</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
